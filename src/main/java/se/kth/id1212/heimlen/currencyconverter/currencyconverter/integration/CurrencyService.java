...
public class CurrencyService {
    ...
    public double Convert(Currency currencyFrom, Currency currencyTo, double amountToConvert) {
        double result = (amountToConvert * currencyFrom.getConversionRate()) / currencyTo.getConversionRate();
        return result;
    }
}
